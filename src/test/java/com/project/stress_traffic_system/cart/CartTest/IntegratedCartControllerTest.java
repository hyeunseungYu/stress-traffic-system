...
package com.project.stress_traffic_system.cart.CartTest;
...
public class IntegratedCartControllerTest {
    ...
    public void getCartItems() throws Exception{
        ...
        mockMvc.perform(get("/api/products/cart")
                ...
                .andExpect(jsonPath(itemName,"test").exists())
                .andExpect(jsonPath(imgurl,1).exists())
                .andExpect(jsonPath(price,12000).exists())
                .andExpect(jsonPath(quantity,2).exists());
    }
